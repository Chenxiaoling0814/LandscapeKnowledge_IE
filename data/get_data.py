...
def load_data(filename):
    ...
    for l in content:
        ...
        D.append({
            'text': l['text'],
            'spo_list': [
               (spo['subject'], spo['predicate'], spo['object'], spo['subject_type'], spo['object_type'])
...
with open('plant.train', 'w', encoding='utf-8') as f:
...
with open('plant.test', 'w', encoding='utf-8') as f:
...
with open('plant.dev', 'w', encoding='utf-8') as f:
